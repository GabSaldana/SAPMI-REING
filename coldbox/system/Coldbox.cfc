...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cfparam name="variables.COLDBOX_DEBUG_SYSTEM" 	default="0" type="numeric">

	<cfscript>
		instance = structnew();
		this.DEBUGGING_FILE = 0;
		...
		//Set the COLDBOX DEBUG SYSTEM
		setCOLDBOX_DEBUG_SYSTEM(COLDBOX_DEBUG_SYSTEM);
	</cfscript>
...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="coldbox" hint="Used when not using inheritance" output="false" >
		...
		<cfargument name="COLDBOX_DEBUG_SYSTEM"  required="false" type="numeric" default="0">
		<cfscript>
			...
			setCOLDBOX_DEBUG_SYSTEM(arguments.COLDBOX_DEBUG_SYSTEM);
	...
	<!--- setter COLDBOX_DEBUG_SYSTEM --->
	<cffunction name="setCOLDBOX_DEBUG_SYSTEM" access="public" output="false" returntype="void" hint="Set setCOLDBOX_DEBUG_SYSTEM">
		<cfargument name="COLDBOX_DEBUG_SYSTEM" type="string" required="true"/>
		<cfset variables.COLDBOX_DEBUG_SYSTEM = arguments.COLDBOX_DEBUG_SYSTEM/>
	</cffunction>
