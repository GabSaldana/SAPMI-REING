...
<cfcomponent>
	...
	* Autor:	Roberto Cadena
	...
	<cffunction name="getProced" access="public" hint="Obtiene todos los procedimientos">
		<cfquery name="qConvenios" datasource="DS_GRAL">
	...
	* Autor:	Roberto Cadena
	--->
	<cffunction name="getAllConvenios" access="public" hint="Obtiene todos los convenios">
	...
	* Autor:	Roberto Cadena
	...
	<cffunction name="getAllAreas" access="public" hint="Obtiene todas las areas">
		<cfargument name="proced"	type="numeric" required="yes" hint="procedimiento">
		<cfquery name="qAreas" datasource="DS_GRAL">
			SELECT	CAR.CAR_PK_AREA		AS PKAREA,
					CAR.CAR_NOMBRE_AREA	AS AREA
			FROM	GRAL.CESCAREA		CAR,
					GRAL.CESCESTADO		CER,
					GRAL.CESBHISTORIAL	BHI,
					GRAL.CESRRUTA		RPR
	...
	* Autor:	Roberto Cadena
	...
	<cffunction name="getAllEstados" access="public" hint="Obtiene todos los estados de los convenios">
		<cfargument name="proced"	type="numeric" required="yes" hint="procedimiento">
		<cfquery name="qEstados" datasource="DS_GRAL">
...
<!--- 		<cfquery name="qEstados" datasource="DS_GRAL">
			...
			FROM(
				...
				AND		TUS.TUS_PK_USUARIO = BHI.BHI_USUARIO_MODIFICACION
				AND		BHI.BHI_FK_ESTADO = 2
				AND		BHI.BHI_FK_PROCEDIMIENTO = <cfqueryparam value="#application.SIIIP_CTES.PROCEDIMIENTO.CONVENIOS_INV#" cfsqltype="cf_sql_numeric">
		...
		<cfreturn qEstados> --->
		<cfstoredproc procedure="P_ADMON_ESTADOS.TIEMPO_TRANSCURRIDO" datasource="DS_GRAL">
