...
<cfcomponent>
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="guardaError" access="public">
		...
		<cftry>
			<cfset separador = ''>
			<cfquery name="qError" datasource="DS_GRAL">
				INSERT INTO GRAL.MONBSTERROR (
					BST_CLAVE_ERROR,
					BST_DESCRIPCION, 
					BST_FK_USUARIO,
					BST_MENSAJE,
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="getErroresRegistrados" access="public" hint="">
		...
		<cfquery name="qErrores" datasource="DS_GRAL">
			SELECT LISTA_ERRORES.*
			  FROM (SELECT ERRORES.BST_PK_ERROR AS PK_ERROR,
					   ...
					   TO_CHAR (ERRORES.BST_FECHAREGISTRO, 'DD/MM/YYYY hh24:mi:ss')
						  AS FECHA_REGISTRO
				  FROM GRAL.MONBSTERROR ERRORES, GRAL.USRTUSUARIO USUARIO,
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="eliminarError" access="public" hint="">
		<cfargument name="pkError"	type="numeric"	required="yes" hint="">
		<cfquery name="delError" datasource="DS_GRAL" result="resultado">
			UPDATE GRAL.MONBSTERROR
			   SET BST_FK_ESTADO = 0
	...
	<cffunction name="getTiposError" access="public" hint="">
		<cfquery name="qTotal" datasource="DS_GRAL">
			SELECT COUNT (*) AS TOTAL_REGISTRO
			  FROM GRAL.MONBSTERROR ERRORES
			 WHERE ERRORES.BST_FK_ESTADO > 0
		</cfquery>
		<cfquery name="qTErrores" datasource="DS_GRAL">
