...
<cfcomponent>
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="registraAccesoUsuario" access="public">
		...
		<cfstoredproc procedure="PDIPIMP.P_MONITOREO.GUARDA_ACCESO" datasource="DS_PDIPIMP">
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="registraAccionesUsuario" access="public">
		...
		<cfstoredproc procedure="PDIPIMP.P_MONITOREO.GUARDA_ACCIONES" datasource="DS_PDIPIMP">
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="getAccesosRegistrados" access="public">
		...
		<cfquery name="qRegistroAcceso" datasource="DS_PDIPIMP">
			...
			FROM (
				SELECT USUARIO.TUS_FK_UR AS UR,
					   ...
					   TO_CHAR (ACCESO.BAC_ACCESO_FECHA_REGISTRO, 'DD/MM/YYYY hh24:mi:ss')
						  AS FECHA_REGISTRO
				  FROM PDIPIMP.MONBACCESO ACCESO,
		...
		<!---
		<cfstoredproc procedure="PDIPIMP.P_MONITOREO.GET_REGISTROSACCESOS" datasource="DS_PDIPIMP">
	...
	* Autor : Sergio E. Cuevas Olivares
	...
	<cffunction name="verDetalleAcceso" access="public">
		...
		<cfstoredproc procedure="PDIPIMP.P_MONITOREO.GET_DETALLEACCESO" datasource="DS_PDIPIMP">
	...
	<cffunction name="getNombresUR" access="public" hint="">
		<cfquery name="qTotal" datasource="DS_PDIPIMP">
			SELECT COUNT (*) AS TOTAL_REGISTRO
			  FROM PDIPIMP.MONBACCESO ACCESOS
