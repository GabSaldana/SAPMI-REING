<cfcomponent>
	...
	<cfproperty name="dao" 			inject="SAPMI.Planeacion.MisionVision.DAO_MisionVision">
	...
	--->        
   	<cffunction name="getIndicadores" hint="">
		<cfscript>
			...
			if(NOT arraycontains(session.cbstorage.grant,'MisionVision.verTodos')){
    ...
    <cffunction name="cambiarEstadoFT" hint="Se cambia el estado del registro en cuestión a partir de la accion que se realiza.">
        ...
        <cfscript>
            ...
            if (registroBitacora.fallo){
                ...
                respuesta.mensaje = estadoactual.NUM_EDO[1];
                return respuesta;
            }
