...
<cfcomponent output="false">
	...
	<!---Seccion de cfwebsocket para el chat--->
	<cfset this.name="cfwack2_11">
	<cfset this.wschannels = [{name="chat1"},{name="chat2"},{name="chat3"}]>
	...
	<cffunction name="onApplicationStart" returnType="boolean" output="false">
		<cfscript>		
			application.SIIIP_CTES = CreateObject("component", "model.adminCSII.constantes.CN_Constantes");
			//Load ColdBox
