                 ...
                 <div class="ibox-title">
                     <div class="row">
                         <div class="col-lg-9">
                             ...
                             <button class="col-lg-2  btn btn-primary nextBtn btn-outline dim btn-xs crearTab " title="Mostrar Reportes Guardados" data-toggle="tooltip" onclick="location.href='#event.buildLink('adminCSII.tablasDinamicas.administradorTablas.crearTabla.idCon.#prc.conjunto.getId()#')#'">
                         ...
                         <div class="ibox-content el-contenido">
                             ...
                             <div class="el-descripcion">
                                 ...
                                 <div class="m-t text-right">
                                     <a class="btn btn-md btn-outline btn-primary explorar" href="#event.buildLink('adminCSII.tablasDinamicas.administradorTablas.explorarTabla.idTab.#rep['tabla'].IDTAB#.idCon.#prc.conjunto.getId()#')#">
                                        Explorar
                                     </a>
                                     <a  class="btn btn-md btn-outline btn-primary editar" href="#event.buildLink('adminCSII.tablasDinamicas.administradorTablas.editarTabla.idTab.#rep['tabla'].IDTAB#.idCon.#prc.conjunto.getId()#')#">
                                        Editar
                                     </a>
                                 </div>
                             </div>
                     ...
                     <div class="ibox" data-tab-id="#rep['tabla'].IDTAB#">
                         <div class="ibox-content el-contenido">
                             ...
                             <div class="el-descripcion">
                                 ...
                                 <div class="m-t text-right">
                                     <a class="btn btn-md btn-outline btn-primary" href="#event.buildLink('adminCSII.tablasDinamicas.administradorTablas.explorarTabla.idTab.#rep['tabla'].IDTAB#.idCon.#prc.conjunto.getId()#')#">
                                        Explorar
                                     </a>
                                 </div>
                             </div>
