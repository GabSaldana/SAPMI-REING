             ...
             <div class="ibox-content el-contenido">
                 ...
                 <div class="el-descripcion">          
                     ...
                     <div class="m-t text-right"> 
                         <a class="btn btn-md btn-outline btn-primary" href="#event.buildLink('adminCSII,tablasDinamicas.administradorTablas.explorarTabla.idTab.#prc.tabla['tabla'].IDTAB#.idCon.#prc.conjunto.getId()#')#">Explorar
                         </a>        
                         <a class="btn btn-md btn-outline btn-primary" href="#event.buildLink('adminCSII.tablasDinamicas.administradorTablas.editarTabla.idTab.#prc.tabla['tabla'].IDTAB#.idCon.#prc.conjunto.getId()#')#">Editar
                         </a>
                    </div>
                </div>
            </div>
