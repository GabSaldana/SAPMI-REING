...
<div id="toolbar">
    <button type="button" class="btn btn-primary btn-outline dim guiaRelAgregarRelacion" data-toggle="modal" href="#mdl-relacion"><span class="glyphicon glyphicon-plus"></span> AGREGAR RELACIÓN</button>
</div>
...
<script>
    ...
    * @author Alejandro Tovar
    ...
    function actionFormatter(value, row, index) {
        return [
            '<button class="btn btn-primary borrar guiaRelEliminar" data-tooltip="tooltip" title="Borrar"> <i class="fa fa-trash"></i> </button>',
            '<button class="btn btn-primary ml5 accionOper guiaRelAgregar" data-tooltip="tooltip" title="Operaciones" data-toggle="modal"> <i class="fa fa-plus"></i> </button>'
        ].join('');
    }
