    ...
    $(document).ready(function() {
        ...
        $("#actualizaUsr").on("click", function() {
            if($("#validaUsuario").valid()){
                ...
                $.post('/index.cfm/adminCSII/usuarios/usuarios/editarUsuario', { 
        ...
        $("#cambiaPwd").on("click", function() {
            if($("#registroForm").valid()){
                ...
                $.post('/index.cfm/adminCSII/usuarios/usuarios/cambiarPwd', { 
                    psw: psw }, function(data) {
                    if (data == -1){
                        toastr.error('La contraseña debe ser distinta a la que se asiganó automáticamente.');
                    }else if (data > 0) {

                        $.post('/index.cfm/adminCSII/usuarios/usuarios/consultarUsuario', { 
