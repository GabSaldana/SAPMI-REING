...
<div id="cajaCorreos" class="wrapper wrapper-content animated fadeIn">
    <div class="ibox float-e-margins">
        <div class="ibox-title guiaMailRegistrados">
...
<div id="mdl-plantillas" class="modal inmodal fade modaltext" tabindex="-1" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false"  style="z-index: 9999 !important;">
...
<div id="mdl-crear" class="modal inmodal fade modaltext" tabindex="-1" role="dialog"  aria-hidden="true" data-backdrop="static" data-keyboard="false"  style="z-index: 9999 !important;">
...
<div id="mdl-confirma" class="modal inmodal fade modaltext" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false"  style="z-index: 9999 !important;" style="z-index: 9999 !important;">
...
<div id="mdl-confirmaEliminar" class="modal inmodal fade modaltext" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index: 9999 !important;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="mdl-vistacorreo" class="modal inmodal fade modaltext" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index: 9999 !important;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<!--- Guia --->
<ul id="tlyPageGuide" data-tourtitle="Correos.">
    <li class="tlypageguide_top" data-tourtarget=".guiaMailRegistrados">
        <div> Correos <br>
            En esta sección se encuentran los correos registrados.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailBtnAgregarCorreo">
        <div> Agregar Correo <br>
            Puede agregar la información del correo.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailBtnAgregarCabecera">
        <div> Agregar cabeceras <br>
            En esta sección se encuentran las cabeceras disponibles y puede agregar cabecera.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailBtnAgregarPie">
        <div> Pies de página <br>
            En esta sección se encuentran los pies de página disponibles y puede agregar pie de página.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".search">
        <div> Búsqueda <br>
            Puede realizar la búsqueda de un correo.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailEditar">
        <div> Editar <br>
            Puede editar la información del correo.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailPrevia">
        <div> Vista previa <br>
            Puede ver la vista previa del correo.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailEliminar">
        <div> Eliminar <br>
            Puede eliminar el correo seleccionado.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaMailHistorial">
        <div> Ver historial de correos <br>
            Muestra una tabla del historial de los correos mandados.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaHistorialInicio">
        <div> Filtro de fecha <br>
            Filtra los correos enviados desde una fecha dada.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaHistorialFin">
        <div> Filtro de fecha <br>
            Filtra los correos enviados hasta una fecha dada.
        </div>
    </li>
    <li class="tlypageguide_top" data-tourtarget=".guiaHistorialMostrarCorreo">
        <div> Mostrar correo seleccionado <br>
