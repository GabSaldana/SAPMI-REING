...
<script type="text/javascript">
 ...
 function bajaProceso(proceso,rol){
       $.post('/index.cfm/admonChat/admonChat/bajaProcesosRol',{proceso:proceso, rol:rol} ,function(data){    
           if (data>0){
                 consultaProcesoRol();
           }
     });
 ...
 function altaProceso(proceso,rol){
      $.post('/index.cfm/admonChat/admonChat/altaProcesosRol',{proceso:proceso, rol:rol} ,function(data){    
           if(data>0){
                 consultaProcesoRol();
           }
     });
