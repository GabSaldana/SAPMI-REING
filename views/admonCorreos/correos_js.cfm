...
function consultarCorreos(){
    $.post('admonCorreos/obtenerCorreos', function(data){
        $('#correos').html(data);
    });
}
...
function editarCorreo(pkCorreo){
    ...
    if (pkCorreo > 0){
        $.post('admonCorreos/obtenerBody', {pkCorreo: pkCorreo}, function(data){
...
function agregarCorreo(){
    ...
    if ($("#nuevoCorreo").valid() && $("#inPkCorreoNuevo").val()==0){
        $.post('admonCorreos/agregarCorreo', {
            nombre: $("#inCorreo").val(),
        ...
        $.post('admonCorreos/editarCorreo', {
...
function vistaCorreo(pkCorreo){
    $.post('admonCorreos/obtenerVistaCorreo', {pkCorreo: pkCorreo}, function(data){
...
function cambiarEstadoCorreo(){
    $.post('admonCorreos/cambiarEstadoCorreo', {
        pk: $('#inPkCorreo').val()
    }, function(data){
        if (data > 0){
            consultarCorreos();
...
function obtienePlantillas(pkHead,pkFoot,pkBody){
    $.post('admonCorreos/obtieneHeaderCarrusel', {pkHead:pkHead}, function(data){
    ...
    $.post('admonCorreos/obtieneFooterCarrusel', {pkFoot:pkFoot}, function(data){
...
function obtieneEtiquetas(pkBody){
    ...
    $.post('admonCorreos/obtieneEtiquetas', {pkBody: pkBody}, function(data){
...
function agregarEtiqueta(){
    if ($("#nuevaEtiqueta").valid()){
        $.post('admonCorreos/agregarEtiqueta', {
            pkBody: $("#inPkBody").val(),
...
function cambiarEstadoEtiqueta(number){
    $.post('admonCorreos/cambiarEstadoEtiqueta', {
...
function obtieneHeader(){
    ...
    $("#tipoPlantilla").val("1");
    $.post('admonCorreos/obtieneHeader',{}, function(data){
...
function obtieneFooter(){
    ...
    $("#tipoPlantilla").val("2");
    $.post('admonCorreos/obtieneFooter', function(data){
        $('#plantillas').html(data);
    });
}
...
function agregarPlant(){
    if ($("#nuevaPlant").valid() && $("#tipoPlantilla").val()==1){
        if ($("#inPkPlant").val()==0){
            $.post('admonCorreos/agregarHeader', {
            ...
            $.post('admonCorreos/editarHeader', {
                pk: $("#inPkPlant").val(),
                nombre: $("#inPlantilla").val(),
                desc: $("#inPlantillaDesc").val(),
                contenido: tinyMCE.get("inContentPlant").getContent()
        ...
        if ($("#inPkPlant").val()==0){
            $.post('admonCorreos/agregarFooter', {
                nombre: $("#inPlantilla").val(),
                desc: $("#inPlantillaDesc").val(),
                contenido: tinyMCE.get("inContentPlant").getContent()
            }, function(data){
            ...
            $.post('admonCorreos/editarFooter', {
                pk: $("#inPkPlant").val(),
                nombre: $("#inPlantilla").val(),
                desc: $("#inPlantillaDesc").val(),
                contenido: tinyMCE.get("inContentPlant").getContent()
...
function vistaPlant(pkPlant){
    if ($("#tipoPlantilla").val()==1){
        $.post('admonCorreos/obtenerVistaHeader', {pkPlant: pkPlant}, function(data){
            $('#plantillaVistaPre').html(data.DATA.HEADER[0]);
        }); 
    } else if ($("#tipoPlantilla").val()==2){
        $.post('admonCorreos/obtenerVistaFooter', {pkPlant: pkPlant}, function(data){
...
function cambiarEstadoPlant(){
    if ($("#tipoPlantillaConf").val()==1){
        $.post('admonCorreos/cambiarEstadoHeader', {
        ...
        $.post('admonCorreos/cambiarEstadoFooter', {
            pk: $('#inPkPlantConf').val()
        }, function(data){
            if (data > 0){
                limpiaOpacidadModal();
...
function getHistorialCorreos(){
    ...
    $.post('<cfoutput>#event.buildLink("admonCorreos.admonCorreos.getHistorialCorreos")#</cfoutput>',{
...
function getCorreo(pkHistorial){
    $.post('<cfoutput>#event.buildLink("admonCorreos.admonCorreos.getCorreo")#</cfoutput>',{
