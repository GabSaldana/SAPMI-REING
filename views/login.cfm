            ...
            <div class="col-md-8">
                ...
                <div class="container text-center" style="margin-top:50px">
                    <div class="row">
                        ...
                        style="height:400px; padding-top: 10px; padding-bottom: 10px; background-color: #78909C; margin-left: 70px; text-align: justify;">
                        ...
                        <div class="col-xs-10 col-md-10 col-lg-10 vcenter" style="width:450px; height:430px; border:none; margin-left: 30px;">
                            ...
                            <map name="Map">
                                <area class="areaMenu" shape="POLY" coords="212,4,369,74,277,160,210,136"    onClick="javascript:openVerdeClaro();"    href="#"     data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." data-boton="btnVerde" 
                                data-color="#88BD1A"/>
                                ...
                                data-color="#C2B52E"/>
                                <area class="areaMenu" shape="POLY" coords="415,230,345,351,274,283,302,229"  onClick="javascript:openNaranja();"  href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
                                data-boton="btnNaranja" 
                                data-color="#DB8323"/>
                                <area class="areaMenu" shape="POLY" coords="342,354,210,399,210,310,269,287"  onClick="javascript:openRojo();"     href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
                                data-boton="btnRojo" 
                                data-color="#D73B26"/>
                                <area class="areaMenu" shape="POLY" coords="204,398,74,353,145,285,206,308"   onClick="javascript:openGuinda();"     href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
                                data-boton="btnGuinda" 
                                data-color="#851E3B"/>
                                <area class="areaMenu" shape="POLY" coords="69,350,143,283,118,224,1,224"     onClick="javascript:openLila();"   href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
                                data-boton="btnVioleta" 
                                data-color="#6E2E7C"/>
                                <area class="areaMenu" shape="POLY" coords="3,220,53,76,142,160,118,221"      onClick="javascript:openMorado();" href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
                                data-boton="btnMarino" 
                                data-color="#6168B2"/>
                                <area class="areaMenu" shape="POLY" coords="52,73,208,6,207,133,143,158"      onClick="javascript:openVerdeObscuro();"   href="#" data-titulo="&Aacute;rea encargada de coordinar la integraci&oacute;n de los programas anuales de trabajo y el programa operativo anual institucional para apoyar el cumplimiento de los objetivos institucionales." 
