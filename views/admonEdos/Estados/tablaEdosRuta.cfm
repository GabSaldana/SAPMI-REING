...
<div id="toolbar">
    <button type="button" class="btn btn-primary btn-outline dim" data-toggle="modal" href="#mdl-estado"><span class="glyphicon glyphicon-plus"></span> AGREGAR ESTADO</button>
</div>
...
<script>
    ...
    * @author Alejandro Tovar
    ...
    function actionFormatter(value, row, index) {
        return [
            '<button class="btn btn-primary ml5 eliminar" data-tooltip="tooltip" title="Eliminar"> <i class="fa fa-trash"></i> </button>'
        ].join('');
    }
