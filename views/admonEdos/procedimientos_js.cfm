...
function consultarUsuarios(){
    $.post('admonEdos/obtenerProced', function(data){
...
function consultarOperaciones(pkProcedimiento){
    $.post('admonEdos/setTablaOpe', {pkProcedimiento: pkProcedimiento}, function(data){
...
$(document).ready(function() {
    ...
    window.actionEvents = {
        'click .route': function (e, value, row, index) {
            window.location = '/index.cfm/admonEdos/admonEdos/setRutas?pkProcedimiento='+ row.id;
        },
