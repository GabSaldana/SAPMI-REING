<script type="text/javascript">
	...
	chart6.addListener("clickGraphItem", function (event) {
		...
		if(pksRegistros != ""){
			...
			$.post('/index.cfm/administrador/error/error/consultaInformacion',
	...
	$(document).ready(function(e) {
		...
		chart5.addListener("clickSlice", function (event) {
			$('#cargador-modal').modal('show');
			$.post('/index.cfm/administrador/error/error/consultaInformacion', {pksRegistro: event.dataItem.description }, function(data){
				$('#cargador-modal').modal('hide');
	...
	function verDetalleError(obj){
		$('#cargador-modal').modal('show');
		$.post('/index.cfm/administrador/error/error/visualizaDetalleError', {pkError: $(obj).attr("data-pkError") },
			function(data){
				$('#cargador-modal').modal('hide');
