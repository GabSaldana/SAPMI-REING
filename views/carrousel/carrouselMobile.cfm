...
* Modulo: Vista del menu secundario, version mobile.
* Sub modulo: -
* Fecha: Marzo 2018
* Descripcion: Vista
* Autor: GSA
=========================================================================
--->
<cfoutput><cfinclude template="carrouselMobile_JS.cfm"></cfoutput>
	<div class="container-fluid">
	  <!--Card Regular-->
	  <div class="row">
<div class="col-md-1"></div>
<div id="accordion" style="display: none;"  class="col-xs-12 col-md-10 col-sm-12" >
		...
		<div id="tablaAcciones" class="col-xs-12 col-md-12 col-sm-12">
			...
			<div class="row" style="border:1px solid #720030;color:#720030;background-color:white;">
				<div class="col-xs-12 col-sm-12 col-md-12 ">
					<center><p id="th_acciones" style="font-size: 4vw;"> Titulo </p></center>
				</div>
			</div>
	...
	<div class ="row" style="margin:0;">
		<div class="ct  col-12 " style=" border-radius: 0px 0px 5px 5px;  padding-bottom: 25px !important; margin-top:0px !important; ">
			<center>
				<cfoutput><a href="#event.buildLink("ejes/ejes")#" style="font-size: 15px;text-decoration: none;" ></cfoutput>
		    	Regresar
