     ...
     $( document ).ready(function() {
        ...
        $("##btnCompartir").click(
         ...
         $("##buttonConfig").on('click', function () {
              $.post('#event.buildLink("tablasDinamicas.creacionTabla.actualizarTabla")#',{
                 ...
                 window.location.assign("#event.buildLink('tablasDinamicas/conjuntosDatos/cargarConjunto.idCon.#prc.conjunto.getId()#')#");
             });
         });
