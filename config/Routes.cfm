<cfscript>
	...
	// 	setBaseURL("http://#cgi.SERVER_NAME#:#cgi.SERVER_PORT#/index.cfm");
	// }
	// else{
	// 	setBaseURL("http://#cgi.SERVER_NAME#:#cgi.SERVER_PORT#/#getSetting('AppMapping')#/index.cfm");
	// }
	//setBaseURL("http://#cgi.SERVER_NAME#:#cgi.SERVER_PORT#/index.cfm");
	//setBaseURL("http://localhost:8501/index.cfm");
