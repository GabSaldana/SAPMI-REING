  ...
  $.fn.extend({
    tableExport: function (options) {
      ...
      if (defaults.type == 'csv' || defaults.type == 'txt') {
        ...
        * Descripcion: se agrega encabezado a los reportes
        */
        padre = $(window.parent.document);       
		    var periodo = padre.find("#displayTrimestre").html();
        var reporte = padre.find("#displayNombre").html();
        ...
        var colsp = (columnas[(Object.keys($('#tablaConsulta').bootstrapTable('getOptions').columns).length)-1].length)-1;
        console.log(colsp);
        // var colsp = (colNames.length)-1;
        var excel = '';
        excel = '<table align="center">';
    		excel += '<tr>';
    		excel += '<td align="center" rowspan="6">';
    		excel += '<img src="http://www.siga.ipn.mx/ipn.png" width="62" height="90"/>';
    		excel += '</td>';
    		excel += '<td align="center" colspan="'+colsp+'">';
    		excel += '<b style="font-size: 24px;font-style: normal;line-height: normal;" >';
    		excel += 'INSTITUTO POLITÉCNICO NACIONAL</b>';
    		excel += '</td></tr><tr>';
    		excel += '<td colspan="'+colsp+'" align="center" style="font-size: 21px;font-style: normal;line-height: normal;">';
    		excel += 'SECRETARÍA DE GESTIÓN ESTRATÉGICA</td></tr><tr>';
    		excel += '<td colspan="'+colsp+'" align="center"  style="font-size: 19px;font-style: normal;line-height: normal;">';
    		excel += 'DIRECCIÓN DE EVALUACIÓN</td></tr><tr>';
    		excel += '<td colspan="'+colsp+'">&nbsp;</td></tr><tr>';
    		excel += '<td colspan="'+colsp+'" align="center"  style="font-size: 19px;font-style: normal;line-height: normal;">';
    		excel += reporte + '</td></tr><tr>';
    		excel += '<td colspan="'+colsp+'" align="center"  style="font-size: 19px;font-style: normal;line-height: normal;">';
    		excel +=  periodo + '</td></tr><tr>';		
    		excel += '</td>';
    		excel += '</tr>';
    		excel += '</table>';
