...
!function ($) {
    ...
    BootstrapTable.prototype.init = function () {
        if (this.options.searchAccentNeutralise) {
            //make sure that the internal variables are loaded correctly
            initNeutraliser();
            this.options.diacriticsMapLoaded = true;
        }
                ...
                for (var key in item) {
                    ...
                    if (index !== -1 && that.header.searchables[index] && (typeof value === 'string' || typeof value === 'number')) {
                        if (that.options.searchAccentNeutralise) {
                            // Add: Aplil/2016: search any word in array
                            if ((removeDiacritics(value) + '').toLowerCase().indexOf(removeDiacritics(s)) !== -1) {
                                return true;
                            }
                        }
