    ...
    tableExport: function (options) {
      var defaults = {
        ...
        jspdf: {orientation: 'landscape',
                ...
                autotable: {styles: {cellPadding: 2,
                            ...
                            headerStyles: {fillColor: [102, 0, 51],
                                           textColor: 255,
                                           fontStyle: 'bold',
                                           halign: 'center'
                                          },
        ...
        theadSelector: 'tr',
        tableName: 'tiempoTranscurrido',
        type: 'csv', // 'csv', 'tsv', 'txt', 'sql', 'json', 'xml', 'excel', 'doc', 'png' or 'pdf'
        worksheetName: 'tiempoTranscurrido'
      };
      ...
      if (defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt') {
        ...
        $tables.each(function(){
          ...
          docData += '<table style="border: 1px solid black;"><thead>';
          // Header
          $hrows = $table.find('thead').first().find(defaults.theadSelector);
          $hrows.each(function() {
            trData = "";
            ForEachVisibleCell(this, 'th,td', rowIndex, $hrows.length,
              function(cell, row, col) {
                if (cell !== null) {
                  ...
                  if (thstyle !== '' )
                    trData += ' ' + thstyle + '" style="background-color:rgb(102, 0, 51); color: white;"';
                  if ($(cell).is("[colspan]"))
          ...
          $($rows).each(function() {
            ...
            if (trData.length > 0){
              if(rowIndex % 2 == 0)
                docData += '<tr style="background-color:rgb(224,224,224);">' + trData + '</tr>';
              else
                docData += '<tr >' + trData + '</tr>';
            }
            rowIndex++;
        ...
        * Descripcion:  Encabezados en la administración de tiempos
        */
        padre = $(window.parent.document);
        var descrp = padre.find("#textoDescripcion").val();
        if (descrp == undefined){
            descrp = '';
        }
        var colsp = (colNames.length)-2;
        var colsp2 = colNames.length;
        var excel = '<table align="center"><tr><td align="center"><img src="http://www.siga.ipn.mx/ipn.png" width="60" height="90"/></td><td align="center" width="120px" height="90" colspan="'+colsp+'" style="font-size: 24px;font-style: normal;line-height: normal;"><b>INSTITUTO POLIT\u0116CNICO NACIONAL</b><br>Sistema Institucional de Informaci\u00F3n de Investigaci\u00F3n y Posgrado</td><td align="center"><img src="https://lh3.googleusercontent.com/-wCOE2ci6kBQ/AAAAAAAAAAI/AAAAAAAAAFw/SV8Cv38VmAk/s640/photo.jpg" width="60" height="90"/></td></tr><tr><td align="center" colspan="'+colsp2+'" style="font-size: 20px;font-style: normal;line-height: normal;">'+descrp+'</td></tr></table>';
