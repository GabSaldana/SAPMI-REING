...
(function ($) {
  $.fn.extend({
    tableExport: function (options) {
      ...
      var trData = '';
      var colNames = [];
      //Definimos los colores para las filas
      var color="";
      var coloresRow=[];
      coloresRow["azulSumaCol"]="#3399ff";
      coloresRow["azulSumaFil"]="#99ccff";
      coloresRow["azulSumaSeccion"]="#66ccff";
      coloresRow["warning"]="#ff9933";
      coloresRow["danger"]="#ff3333";
      coloresRow["azulSumaFilUltima"]="#0066cc";
              ...
              function(cell, row, col) {
                if (cell != null) {
                   if(typeof(color) === "undefined"){
                    ...
                    trData += '<td style="background:'+coloresRow[color]+';';
                   }
                 /* for (var styles in defaults.excelstyles) {
                    if (defaults.excelstyles.hasOwnProperty(styles)) {
                      trData += defaults.excelstyles[styles] + ': ' + $(cell).css(defaults.excelstyles[styles]) + ';';
