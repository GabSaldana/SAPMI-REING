...
($traceurRuntime.createClass)(Comments, {
  ...
  addToContextMenu: function(defaultOptions) {
    ...
    defaultOptions.items.push(Handsontable.ContextMenu.SEPARATOR, {
      key: 'commentsAddEdit',
      name: (function() {
        return $__5.checkSelectionCommentsConsistency() ? 'Editar Descripcion ' : 'Agregar Descripcion';
      }),
      callback: (function() {
...
function ContextMenu(instance, customOptions) {
  ...
  this.defaultOptions = {items: [{
      ...
      key: 'col_left',
      name: 'Insertar celda a la izquierda',
      callback: function(key, selection) {
      ...
      key: 'col_right',
      name: 'Insertar celda a la derecha',
      callback: function(key, selection) {
...
var addMergeActionsToContextMenu = function(defaultOptions) {
  ...
  defaultOptions.items.push({
    ...
    name: function() {
      ...
      if (info) {
        return 'Separar celdas Ctrl + M';
      } else {
        return 'Unir celdas Ctrl + M';
      }
    },
    callback: function() {
      this.mergeCells.mergeOrUnmergeSelection(this.getSelectedRange());
