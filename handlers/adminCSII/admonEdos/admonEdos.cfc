<cfcomponent>
	<cfproperty name="cnEdos" inject="adminCSII.admonEdos.CN_estados">
	...
	<cffunction name="index" access="remote" returntype="void" output="false">
		...
		<cfset event.setView("adminCSII/admonEdos/procedimientos")>
	</cffunction>
	...
	* Descripcion: Obtiene la tabla con los procedimientos disponibles.
	...
	<cffunction name="obtenerProced" hint="Obtiene procedimientos">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/tablaProced").noLayout();
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene la vista principal para visualizar las rutas.
	...
	<cffunction name="setRutas" hint="Obtiene las rutas ligadas a un procedimiento">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Rutas/rutas");
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene la tabla con las rutas disponibles en algún procedimiento.
	...
	<cffunction name="getTablaEstados" hint="Obtiene la vista de las rutas">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Rutas/tablaRutas").noLayout();
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene la vista principal para visualizar los estados relacionados a una ruta.
	...
	<cffunction name="setEstados" hint="Obtiene vista donde se mostraran los estados de las rutas">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Estados/estadosRutas");
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene la tabla con los estados disponibles en alguna ruta.
	...
	<cffunction name="getTablaEstadosRutas" hint="Obtiene los estados pertenecientes a una ruta">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Estados/tablaEdosRuta").noLayout();
		</cfscript>
	</cffunction>
	...
	* Descripcion: Funcion que agrega un nuevo estado relacionado a una ruta
	...
	<cffunction name="addEstado" hint="Guarda nuevo estado relacionado a un prodedimiento">
		...
		<cfscript>
			var rc = Event.getCollection();
			var resultado = cnEdos.addEstado(rc.ruta, rc.numero, rc.nombre, rc.descr, rc.area);
	...
	* Descripcion: Obtiene la vista principal para visualizar las relaciones con que cuenta una ruta.
	...
	<cffunction name="setRelaciones" hint="Obtiene las relaciones rol-estados">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Relacion/relacion");
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene la tabla con las relaciones con que cuenta una ruta.
	...
	<cffunction name="setTablaRelaciones" hint="Obtiene vista de las relaciones">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Relacion/tablaRelacion").noLayout();
		</cfscript>
	</cffunction>
    ...
    * Autor:	Roberto Cadena
    --->
	<cffunction name="getOpcionesGrafo" hint="Obtiene las opciones del grafo">
		<cfargument name="Event" type="any">
		<cfscript>
			var rc = Event.getCollection();
			prc.operaciones = cnEdos.getOperaciones(rc.pkRuta);
			prc.acciones = cnEdos.getAllAcciones(rc.pkRuta);
			prc.estados = cnEdos.getAllEstados(rc.pkRuta);
			prc.roles = cnEdos.getAllRoles(rc.pkRuta);
			prc.ruta = rc.pkRuta;
			event.setView("adminCSII/admonEdos/Rutas/opcionesGrafo").noLayout();
		</cfscript>
	</cffunction>
    ...
    * Autor:	Roberto Cadena
    --->
	<cffunction name="getDatoGrafoFiltros" hint="Obtiene la vista para mostrar la vista del grafo con filtros">
		<cfargument name="Event" type="any">
		<cfscript>
			var rc = Event.getCollection();
			prc.rutas = cnEdos.setRelacionesFiltros(rc.pkRuta, rc.roles, rc.acciones, rc.estados);
			event.setView("adminCSII/admonEdos/Rutas/grafo").noLayout();
		</cfscript>
	</cffunction>
	...
	* Descripcion: Obtiene las operaciones que se pueden realizar al ejecutar una acción.
	...
	<cffunction name="setTablaAccOpe" hint="Obtiene tabla de operaciones">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/Relacion/tablaAccionOperacion").noLayout();
		</cfscript>
	</cffunction>
    ...
    * @author SGS
	...
	<cffunction name="setTablaOpe" hint="Obtiene las operaciones para la tabla de procedimientos">
		...
		<cfscript>
			...
			event.setView("adminCSII/admonEdos/tablaOperaciones").noLayout();
		</cfscript>
	</cffunction>
