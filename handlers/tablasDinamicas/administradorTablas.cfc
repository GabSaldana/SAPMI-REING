...
--->
 <cfcomponent>
	 ...
	 <cfproperty name="cn" inject="tablasDinamicas/CN_Tabla">
	 <cfproperty name="cnUsr" inject="tablasDinamicas/CN_Usuario">
  	 <!---
	   	 *Fecha :23 de marzo de 2017
	 ...
	 <cffunction name="crearTabla" hint="Redireciona a la pagina para la creación de una tabla">
		 <cfscript>
			 ...
			 event.setView("tablasDinamicas/creacionTabla");
		 </cfscript>
	 </cffunction>
     <!---
	 	 *Fecha :23 de marzo de 2017
	 ...
	 <cffunction name="explorarTabla" hint="">
		 <cfscript>
			 ...
			 event.setView("tablasDinamicas/exploradorTablas");
		 </cfscript>		
	 </cffunction>
	 <!---
	...
	<cffunction name="editarTabla" hint="">
		 <cfscript>
			 prc.conjunto=cnConjuntos.obtenerConjuntoPorId(rc.idCon);
			 prc.tabla=cn.obtenerTablaPorId(rc.idTab);
			 event.setView("tablasDinamicas/editorTabla");
		 </cfscript>	
	 </cffunction>
	 <!---
	 ...
	 <cffunction name="copiarTabla" hint="">
		 <cfscript>
			 ...
			 event.renderData(data=renderView("tablasDinamicas/tabla"));
		 </cfscript>
	 </cffunction>
	 <!---
		 *Fecha :28 de marzo de 2017
	 ...
	 <cffunction name="obtenerUsuariosAutorizados" hint="">
		 <cfscript>
			 ...
			 event.renderData(data=renderView("tablasDinamicas/listaUsuarios"));
		 </cfscript>
	 </cffunction>
	 <!---
		 *Fecha :28 de marzo de 2017
