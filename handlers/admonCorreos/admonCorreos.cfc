...
<cfcomponent>
	<cfproperty name="cnAdmonCorreos" inject="admonCorreos.CN_correos">

	<cffunction name="index" access="remote" returntype="void" output="false">
		<cfargument name="event" type="any">
		<cfset event.setView("admonCorreos/correos")>
	</cffunction>
	...
	<cffunction name="obtenerCorreos" hint="Obtiene correos para la tabla de correos">
		...
		<cfscript>
			...
			event.setView("admonCorreos/tablaCorreos").noLayout();
		</cfscript>
	</cffunction>
	...
	<cffunction name="obtieneHeader" hint="Obtiene las plantillas header para la tabla">
		...
		<cfscript>
			...
			event.setView("admonCorreos/tablaPlantillas").noLayout();
		</cfscript>
	</cffunction>
	...
	<cffunction name="getHistorialCorreos" hint="Cambia el estado de una etiqueta">
		...
		<cfscript>
			...
			event.setView("admonCorreos/historialCorreos").noLayout();
		</cfscript>
	</cffunction>
